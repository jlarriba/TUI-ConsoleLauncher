...
import es.jlarriba.txt.managers.RegexManager;
import es.jlarriba.txt.managers.TerminalManager;
import es.jlarriba.txt.managers.TimeManager;
import es.jlarriba.txt.managers.TuiLocationManager;
import es.jlarriba.txt.managers.notifications.KeeperService;
import es.jlarriba.txt.managers.notifications.NotificationManager;
import es.jlarriba.txt.managers.notifications.NotificationMonitorService;
import es.jlarriba.txt.managers.notifications.NotificationService;
import es.jlarriba.txt.managers.suggestions.SuggestionsManager;
import es.jlarriba.txt.managers.xml.XMLPrefsManager;
import es.jlarriba.txt.managers.xml.options.Behavior;
import es.jlarriba.txt.managers.xml.options.Notifications;
import es.jlarriba.txt.managers.xml.options.Theme;
import es.jlarriba.txt.managers.xml.options.Ui;
import es.jlarriba.txt.tuils.Assist;
import es.jlarriba.txt.tuils.CustomExceptionHandler;
import es.jlarriba.txt.tuils.LongClickableSpan;
import es.jlarriba.txt.tuils.PrivateIOReceiver;
import es.jlarriba.txt.tuils.PublicIOReceiver;
import es.jlarriba.txt.tuils.SimpleMutableEntry;
import es.jlarriba.txt.tuils.Tuils;
import es.jlarriba.txt.tuils.interfaces.Inputable;
import es.jlarriba.txt.tuils.interfaces.Outputable;
...
public class LauncherActivity extends AppCompatActivity implements Reloadable {
    ...
    public static final int TXTXT_REQUEST = 10;
...
//        }
    ...
    protected void onActivityResult(int requestCode, int resultCode, Intent data) {
        ...
        if(requestCode == TXTXT_REQUEST && resultCode != 0) {
            if(resultCode == TxtxtActivity.BACK_PRESSED) {
                Tuils.sendOutput(this, R.string.txtxt_back_pressed);
            } else {
                Tuils.sendOutput(this, data.getStringExtra(TxtxtActivity.ERROR_KEY));
            }
