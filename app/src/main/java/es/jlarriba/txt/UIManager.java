...
import es.jlarriba.txt.managers.HTMLExtractManager;
import es.jlarriba.txt.managers.NotesManager;
...
import es.jlarriba.txt.managers.suggestions.SuggestionTextWatcher;
...
import es.jlarriba.txt.managers.xml.options.Suggestions;
import es.jlarriba.txt.managers.xml.options.Theme;
import es.jlarriba.txt.managers.xml.options.Toolbar;
import es.jlarriba.txt.managers.xml.options.Ui;
import es.jlarriba.txt.tuils.AllowEqualsSequence;
import es.jlarriba.txt.tuils.NetworkUtils;
import es.jlarriba.txt.tuils.OutlineTextView;
import es.jlarriba.txt.tuils.Tuils;
import es.jlarriba.txt.tuils.interfaces.CommandExecuter;
import es.jlarriba.txt.tuils.interfaces.OnBatteryUpdate;
import es.jlarriba.txt.tuils.interfaces.OnRedirectionListener;
import es.jlarriba.txt.tuils.stuff.PolicyReceiver;
