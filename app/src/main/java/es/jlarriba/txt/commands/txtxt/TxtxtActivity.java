...
public class TxtxtActivity extends Activity {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        CommandGroup group = new CommandGroup(this, "es.jlarriba.txt.commands.txtxt.raw");
...
//        end setup part, now start
        ...
        pack = new TxtxtPack(group, file, this, fileView);

        fileView.setText(getString(R.string.txtxt_reading) + Tuils.SPACE + path);
        new StoppableThread() {
                ...
                try {
                    ...
                    runOnUiThread(() -> {
                        try {
                            ...
                            Toast.makeText(TxtxtActivity.this, R.string.txtxt_error, Toast.LENGTH_LONG).show();
                        }
                    });
                } catch (Exception e) {
                    Log.e("andre", "", e);
