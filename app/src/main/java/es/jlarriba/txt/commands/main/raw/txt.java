...
import es.jlarriba.txt.BuildConfig;
...
public class txt extends ParamCommand {

    private enum Param implements es.jlarriba.txt.commands.main.Param {
        ...
        log {
            ...
            public String onNotArgEnough(ExecutePack pack, int n) {
                return pack.context.getString(R.string.help_txt);
            }
        },
        priority {
            @Override
        ...
        sourcecode {
            @Override
            public String exec(ExecutePack pack) {
                pack.context.startActivity(Tuils.webPage("https://github.com/jlarriba/TXT-Launcher"));
                return null;
            }
        },
        discord {
            @Override
            public String exec(ExecutePack pack) {
                pack.context.startActivity(Tuils.webPage("https://discord.gg/Z4H4frxK97"));
                return null;
            }
        },
        reset {
            ...
            public String exec(ExecutePack pack) {
                ...
                ((LauncherActivity) pack.context).addMessage(pack.context.getString(R.string.txt_reset), null);
    ...
    @Override
    protected es.jlarriba.txt.commands.main.Param paramForString(MainPack pack, String param) {
