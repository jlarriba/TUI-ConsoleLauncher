...
import static es.jlarriba.txt.managers.TerminalManager.FORMAT_INPUT;
import static es.jlarriba.txt.managers.TerminalManager.FORMAT_NEWLINE;
import static es.jlarriba.txt.managers.TerminalManager.FORMAT_PREFIX;
