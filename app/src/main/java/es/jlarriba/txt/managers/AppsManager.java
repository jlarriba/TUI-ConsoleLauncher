...
import static es.jlarriba.txt.managers.xml.XMLPrefsManager.resetFile;
...
//                todo support delete
                ...
                Tuils.sendOutput(Color.RED, context, R.string.txtnotfound_app);
            }
        ...
        for (UserHandle profile : userManager.getUserProfiles()) {
            for (LauncherActivityInfo app : launcherApps.getActivityList(null, profile)) {
                ...
                try {
                    ...
                    // txt is not the default launcher
                    Tuils.log(e);
                }
...
//    }
    ...
    public static class LaunchInfo implements Parcelable, StringableObject, Comparable<LaunchInfo> {
        ...
        public LaunchInfo(ComponentName componentName, String label) {
            ...
            setLabel(label);
            this.profile = Process.myUserHandle();
        }

        public LaunchInfo(ComponentName componentName, String label, UserHandle profile) {
            this.componentName = componentName;
            setLabel(label);
