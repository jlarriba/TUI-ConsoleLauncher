...
import es.jlarriba.txt.commands.main.raw.location;
...
import es.jlarriba.txt.managers.MessagesManager;
import es.jlarriba.txt.managers.RssManager;
import es.jlarriba.txt.managers.TerminalManager;
import es.jlarriba.txt.managers.ThemeManager;
...
import es.jlarriba.txt.managers.music.MusicService;
...
import es.jlarriba.txt.tuils.libsuperuser.Shell;
...
public class MainManager {
    ...
    private final String COMMANDS_PKG = "es.jlarriba.txt.commands.main.raw";
