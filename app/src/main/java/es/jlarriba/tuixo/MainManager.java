...
import es.jlarriba.tuixo.commands.Command;
import es.jlarriba.tuixo.commands.CommandGroup;
import es.jlarriba.tuixo.commands.CommandTuils;
import es.jlarriba.tuixo.commands.main.MainPack;
import es.jlarriba.tuixo.commands.main.raw.location;
import es.jlarriba.tuixo.commands.main.specific.RedirectCommand;
import es.jlarriba.tuixo.managers.AliasManager;
import es.jlarriba.tuixo.managers.AppsManager;
import es.jlarriba.tuixo.managers.ChangelogManager;
import es.jlarriba.tuixo.managers.ContactManager;
import es.jlarriba.tuixo.managers.HTMLExtractManager;
import es.jlarriba.tuixo.managers.MessagesManager;
import es.jlarriba.tuixo.managers.RssManager;
import es.jlarriba.tuixo.managers.TerminalManager;
import es.jlarriba.tuixo.managers.ThemeManager;
import es.jlarriba.tuixo.managers.TimeManager;
import es.jlarriba.tuixo.managers.TuiLocationManager;
import es.jlarriba.tuixo.managers.music.MusicManager2;
import es.jlarriba.tuixo.managers.music.MusicService;
import es.jlarriba.tuixo.managers.notifications.KeeperService;
import es.jlarriba.tuixo.managers.xml.XMLPrefsManager;
import es.jlarriba.tuixo.managers.xml.options.Behavior;
import es.jlarriba.tuixo.managers.xml.options.Theme;
import es.jlarriba.tuixo.tuils.PrivateIOReceiver;
import es.jlarriba.tuixo.tuils.StoppableThread;
import es.jlarriba.tuixo.tuils.Tuils;
import es.jlarriba.tuixo.tuils.interfaces.CommandExecuter;
import es.jlarriba.tuixo.tuils.interfaces.OnRedirectionListener;
import es.jlarriba.tuixo.tuils.interfaces.Redirectator;
import es.jlarriba.tuixo.tuils.libsuperuser.Shell;
import es.jlarriba.tuixo.tuils.libsuperuser.ShellHolder;
...
public class MainManager {
    ...
    private final String COMMANDS_PKG = "es.jlarriba.tuixo.commands.main.raw";
