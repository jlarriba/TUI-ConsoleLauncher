...
import es.jlarriba.tuixo.managers.NotesManager;
...
import es.jlarriba.tuixo.managers.suggestions.SuggestionTextWatcher;
...
import es.jlarriba.tuixo.managers.xml.options.Toolbar;
import es.jlarriba.tuixo.managers.xml.options.Ui;
import es.jlarriba.tuixo.tuils.AllowEqualsSequence;
import es.jlarriba.tuixo.tuils.NetworkUtils;
import es.jlarriba.tuixo.tuils.OutlineTextView;
import es.jlarriba.tuixo.tuils.Tuils;
import es.jlarriba.tuixo.tuils.interfaces.CommandExecuter;
import es.jlarriba.tuixo.tuils.interfaces.OnBatteryUpdate;
import es.jlarriba.tuixo.tuils.interfaces.OnRedirectionListener;
import es.jlarriba.tuixo.tuils.stuff.PolicyReceiver;
