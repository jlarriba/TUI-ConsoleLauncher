...
import static es.jlarriba.tuixo.UIManager.PREFS_NAME;
...
public class config extends ParamCommand {
    ...
    private enum Param implements es.jlarriba.tuixo.commands.main.Param {
...
//                    is font
    ...
    @Override
    protected es.jlarriba.tuixo.commands.main.Param paramForString(MainPack pack, String param) {
