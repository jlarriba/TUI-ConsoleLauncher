...
import es.jlarriba.tuixo.commands.tuixt.TuixtActivity;
import es.jlarriba.tuixo.managers.ContactManager;
import es.jlarriba.tuixo.managers.RegexManager;
...
import es.jlarriba.tuixo.managers.notifications.NotificationManager;
import es.jlarriba.tuixo.managers.notifications.NotificationMonitorService;
import es.jlarriba.tuixo.managers.notifications.NotificationService;
import es.jlarriba.tuixo.managers.suggestions.SuggestionsManager;
import es.jlarriba.tuixo.managers.xml.XMLPrefsManager;
import es.jlarriba.tuixo.managers.xml.options.Behavior;
import es.jlarriba.tuixo.managers.xml.options.Notifications;
import es.jlarriba.tuixo.managers.xml.options.Theme;
import es.jlarriba.tuixo.managers.xml.options.Ui;
import es.jlarriba.tuixo.tuils.Assist;
import es.jlarriba.tuixo.tuils.CustomExceptionHandler;
import es.jlarriba.tuixo.tuils.LongClickableSpan;
import es.jlarriba.tuixo.tuils.PrivateIOReceiver;
import es.jlarriba.tuixo.tuils.PublicIOReceiver;
import es.jlarriba.tuixo.tuils.SimpleMutableEntry;
import es.jlarriba.tuixo.tuils.Tuils;
import es.jlarriba.tuixo.tuils.interfaces.Inputable;
import es.jlarriba.tuixo.tuils.interfaces.Outputable;
